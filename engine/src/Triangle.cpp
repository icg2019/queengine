...
std::vector<glm::vec3> Triangle::get_coordinates() { return this->coordinates; }
...
bool Triangle::point_is_inside(glm::vec3 mouse_position) {
  double a =
      area(this->coordinates[0], this->coordinates[1], this->coordinates[2]);
...
void Triangle::set_texture_coordinates(
    std::vector<glm::vec2> texture_coordinates) {
  this->texture_coordinates = texture_coordinates;
}

std::string Triangle::get_texture_path() { return this->texture_path; }
...
BufferSet Triangle::get_buffer_set() { return this->bufferSet; }
